...
public class ForMainActivity extends AppCompatActivity {
    TextView tvOutput,employee_name,employee_age,employee_salary;
   ...
   listCall.enqueue(new Callback<List<Employee>>() {
       ...
       public void onResponse(Call<List<Employee>> call, Response<List<Employee>> response) {
           if (!response.isSuccessful()){
               Toast.makeText(ForMainActivity.this, "Error code", Toast.LENGTH_SHORT).show();
               return;
           }
       ...
       public void onFailure(Call<List<Employee>> call, Throwable t) {
           ...
           Toast.makeText(ForMainActivity.this, "Error" + t.getLocalizedMessage(),Toast.LENGTH_SHORT);
